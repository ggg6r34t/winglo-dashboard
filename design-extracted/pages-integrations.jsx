// Integrations — connected sources grouped by category.
    ...
    <div className="page fade-in">
      <div className="page-head">
        ...
        <div className="page-head-right">
          <button className="btn"><Icon name="search" size={13} />Browse catalog</button>
          <button className="btn primary"><Icon name="plus" size={13} />Connect source</button>
        </div>
      </div>
