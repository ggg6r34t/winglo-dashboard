...
function ReportCard({ r }: { r: Report }) {
  ...
  return (
    <div className={"report-full" + (r.pinned ? " pinned" : "")}>
      ...
      <div className="report-full-foot">
        <div className="report-author">
          <PageAgentGlyph agentId={r.agent} size={20} />
    ...
    <div className="page fade-in">
      <div className="page-head">
        ...
        <div className="page-head-right">
          ...
          <button className="btn primary">Commission report</button>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="reports-grid">
          {pinned.map(r => <ReportCard key={r.id} r={r} />)}
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="reports-grid">
          {filteredRest.map(r => <ReportCard key={r.id} r={r} />)}
        </div>
      </div>
    </div>
  )
